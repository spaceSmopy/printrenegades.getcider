					...
					<div class="metabox-holder wpos-pro-box">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<h3 class="hndle">
									<span><?php _e( 'Upgrate to Pro', 'slider-and-carousel-plus-widget-for-instagram' ); ?></span>
								</h3>
								<div class="inside">
									<ul class="wpos-list">
										<li>10+ Designs</li>
										...
										<li>Responsive</li>
										<li>Given shortcode and template code.</li>
										<li>Grid View.</li>
										<li>Slider View.</li>
										<li>Grid Block View.</li>
										<li>2 Widgets Ready.</li>
										<li>WP Templating Features.</li>
										<li>Gutenberg Block Supports.</li>
										<li>Visual Composer / WPBakery Page Builder Supports</li>
										<li>Cache Time can be adjusted.</li>
										<li>Clear all Caches @ Single click.</li>
										<li>Custom CSS.</li>
										<li>Center Mode With Slider.</li>
										<li>Attractive Popup design for detail view of picture.</li>
									</ul>
									<div class="upgrade-to-pro">Gain access to <strong>Slider and Carousel Plus Widget for Social Media</strong> included in <br /><strong>Essential Plugin Bundle</div>
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/slider-and-carousel-plus-widget-for-instagram/?ref=WposPratik&utm_source=WP&utm_medium=WP-Plugins&utm_campaign=Upgrade-PRO" target="_blank"><?php _e('Go Premium ', 'slider-and-carousel-plus-widget-for-instagram'); ?></a>
									<p><a class="button button-primary wpos-button-full" href="https://demo.wponlinesupport.com/prodemo/slider-and-carousel-plus-widget-for-instagram-pro/" target="_blank"><?php _e('View PRO Demo ', 'slider-and-carousel-plus-widget-for-instagram'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
