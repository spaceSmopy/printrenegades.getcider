# Printrenegades Elementor [![Built with Grunt](https://cdn.gruntjs.com/builtwith.svg)](http://gruntjs.com/)
...
***Printrenegades Elementor*** is distributed under the terms of the GNU GPL v3 or later.
...
2. Type "Printrenegades Elementor" in the search field.
...
* `printrenegades_elementor_enqueue_style`                 enqueue style
* `printrenegades_elementor_enqueue_theme_style`           load theme-specific style (default: load)
* `printrenegades_elementor_load_textdomain`               load theme's textdomain
* `printrenegades_elementor_register_menus`                register the theme's default menu location
* `printrenegades_elementor_add_theme_support`             register the various supported features
* `printrenegades_elementor_add_woocommerce_support`       register woocommerce features, including product-gallery zoom, swipe & lightbox features
* `printrenegades_elementor_register_elementor_locations`  register elementor settings
* `printrenegades_elementor_content_width`                 set default content width to 800px
* `printrenegades_elementor_page_title`                    show\hide page title (default: show)
* `printrenegades_elementor_viewport_content`              modify `content` of `viewport` meta in header

## Frequently Asked Questions ##

**Does this theme support any plugins?**

Printrenegades Elementor includes support for WooCommerce.
...
Printrenegades Elementor bundles the following third-party resources:
...
### 2.2.1 - 2019-09-10 ###
* Tweak: Added max width to `wp-caption` ([#91](https://github.com/elementor/printrenegades-theme/issues/91))
* Tweak: Added support of `wp_body_open`

### 2.2.0 - 2019-07-22 ###
* Tweak: Added viewport content filter ([#49](https://github.com/elementor/printrenegades-theme/issues/49))
...
* Tweak: Remove header tags with `printrenegades_elementor_page_title` filter
...
* New: Added `printrenegades_elementor_page_title` filter for show\hide page title
* New: Added `printrenegades_elementor_enqueue_theme_style` filter for enqueue theme-specific style
...
### 2.0.5 - 2019-05-21 ###
* New: Inroducing [Printrenegades Theme Child](https://github.com/elementor/printrenegades-theme-child)
...
### 2.0.2 - 2019-05-13 ###
* Tweak: Added `printrenegades_elementor_content_width` filter, as per WordePress best practice
...
* Tweak: Change functions.php methods names prefix from `printrenegades_elementor_theme_` to `printrenegades_elementor_`
...
* New: Added `printrenegades_theme_load_textdomain` filter for load theme's textdomain
* New: Added `printrenegades_theme_register_menus` filter for register the theme's default menu location
* New: Added `printrenegades_theme_add_theme_support` filter for register the various supported features
* New: Added `printrenegades_theme_add_woocommerce_support` filter for register woocommerce features, including product-gallery zoom, swipe & lightbox features
* New: Added `printrenegades_theme_enqueue_style` filter for enqueue style
* New: Added `printrenegades_theme_register_elementor_locations` filter for register elementor settings
